      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-3xl mx-auto text-gray-300 text-lg">
            Join futuristic workshops, robotics bootcamps, and cutting-edge
            engineering events designed to push your technical skills to the next level.
          </p>
        </div>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 p-8 relative z-10">
                ...
                <p className="text-gray-300 leading-relaxed mb-6">
                  Summer of Robotics is ERC's flagship robotics bootcamp where ideas
                  turn into intelligent machines. Dive into the complete robotics pipeline
                  — from robot anatomy, CAD modelling, and URDF design to ROS2 simulations in Gazebo.
                  Build autonomous systems using SLAM, OpenCV, YOLOv8, MoveIt, RSSI heatmaps,
                  and Ollama-powered robotics AI while working on exciting real-world projects
                ...
                <a
                  ...
                  className="group px-6 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-medium transition-all duration-300 inline-flex items-center shadow-lg hover:-translate-y-1 hover:shadow-cyan-500/40 active:scale-95"
                >
                  Register Now
          ...
          <div className="relative col-span-1 lg:col-span-2 rounded-3xl overflow-hidden border border-orange-400/20 bg-white/[0.06] backdrop-blur-md shadow-[0_0_40px_rgba(255,140,0,0.12)] hover:shadow-[0_0_55px_rgba(255,140,0,0.18)] transition-all duration-500">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 p-8 order-1 md:order-2 relative z-10">
                ...
                <p className="text-gray-300 leading-relaxed mb-6">
                  The ITSP Bootcamp introduced participants to embedded systems,
                  sensors, microcontrollers, and IoT development while exploring
                  tools like Gazebo, Proteus, MATLAB, and Simulink — making it
                  the perfect launchpad for hardware and robotics projects.
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  >
                    ...
                    <ArrowRight
                      size={16}
                      className="ml-2 transition-transform duration-300 group-hover/resources:translate-x-1"
                    />
                  </a>
                  ...
                  >
                    ...
                    <ArrowRight
                      size={16}
                      className="ml-2 transition-transform duration-300 group-hover/slides:translate-x-1"
                    />
                  </a>
        ...
        <div className="mt-12 p-6 bg-white/[0.06] backdrop-blur-md rounded-3xl border border-white/10 text-center mb-20 shadow-2xl">
          ...
          <p className="text-gray-300 mb-6">
            Subscribe to receive updates about workshops,
            robotics bootcamps, competitions, and club activities.
          </p>
