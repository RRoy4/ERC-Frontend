...
import { Heart, ChevronRight, Linkedin } from 'lucide-react';
...
const legalLinks = [
  ...
  {
    label: 'SAC Constitution, IIT Bombay',
    href: 'https://gymkhana.iitb.ac.in/SAC-Constitution-March-2018.pdf',
  },
  {
    label: 'Students Gymkhana, IIT Bombay',
...
const socialPlatforms = [
  {
    name: 'Instagram',
    href: 'https://instagram.com/erc.iitb',
    icon: 'instagram',
  },
  {
    name: 'GitHub',
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/company/erc-iitb/',
    icon: 'linkedin',
  },
];
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-sm mb-6 leading-relaxed">
              Empowering students to explore the exciting world of electronics
              and robotics through hands-on projects, competitions,
              ...
              {socialPlatforms.map((platform) => (
                ...
                >
                  ...
                  {platform.icon === 'linkedin' ? (
                    ...
                    <i className={`fab fa-${platform.icon} text-xl`}></i>
                  )}
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center md:text-left md:flex md:items-center md:justify-between">
          ...
          <p className="text-sm text-gray-500 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Electronics & Robotics Club,
          ...
          <div className="text-sm text-gray-500 flex items-center justify-center md:justify-end">
            ...
            <Heart
              size={14}
              className="mx-1 text-orange-600"
            />
