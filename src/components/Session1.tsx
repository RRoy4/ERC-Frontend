...
const Session1 = () => {
  ...
  const handleAssignmentSubmit = async (
    ...
    try {
      ...
      setErrorMsg("Submission failed. Try logging in again by clicking on the SOR button.");
      console.error(error);
    } finally {
      setSubmitting(false);
    }
            ...
            {!user ? (
              <div className="flex flex-col items-center justify-center py-10">
                <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6 text-center max-w-lg mx-auto">
                  ...
                  <a 
                    href="/" 
                    className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 px-6 py-3 rounded-xl transition-colors font-medium"
                  >
                    Go back to Login
                  </a>
                </div>
              ...
              <form onSubmit={handleAssignmentSubmit} className="max-w-2xl mx-auto space-y-6"> 
                ...
                <div className="text-left">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700 focus:border-blue-500 focus:outline-none resize-none"
                  />
                </div>
                ...
                <div className="text-left">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700 focus:border-blue-500 focus:outline-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting} 
                  className="w-full bg-blue-600 hover:bg-blue-500 py-3 rounded-xl font-medium transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
